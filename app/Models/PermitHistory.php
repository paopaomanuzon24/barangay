...
class PermitHistory extends Model
{
    ...
    protected $fillable = [
        'permit_type_id','category_id','barangay_id','template_id','control_number','user_id','payment_method_id','status_id','release_date','file_name','file_path','reference_number','is_waive','waive_reason'
    ];
